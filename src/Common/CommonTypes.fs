module CommonTypes
    ...
    // CCForm and SheetInfo were added here purely to make the Common dotnet project
    // able to build on its own. This was necessary in order to make issie play nicely
    // with my IDE.
    type CCForm =
        |User
        |Library
